...
// const login_togglePassword = document.querySelector('#login_togglePassword');

// const login_password = document.querySelector('#password');
// const register_password = document.querySelector('#register-password')

// register_togglePassword.addEventListener('click', function (e) {
//     const type = register_password.getAttribute('type') === 'password' ? 'text' : 'password';
//     register_password.setAttribute('type', type);
//     this.classList.toggle('fa-eye-slash');
// });

// login_togglePassword.addEventListener('click', function (e) {
